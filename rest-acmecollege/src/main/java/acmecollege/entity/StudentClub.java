...
@Type(value = NonAcademicStudentClub.class, name = "nonacademic_student_club")})
public abstract class StudentClub extends PojoBase implements Serializable {
	...
	@OneToMany(cascade = CascadeType.MERGE, fetch = FetchType.LAZY, mappedBy = "club", orphanRemoval = true)
